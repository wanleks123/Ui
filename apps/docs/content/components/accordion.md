...
## Dynamic
Gunakan direktif v-for untuk merender panel secara dinamis berdasarkan data array.
...
<script setup>
// Tidak perlu logika tambahan, cukup pastikan :value di template adalah array
</script>
```
::