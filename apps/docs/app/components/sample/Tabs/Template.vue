...
<template>
    <DocsCard>
        <UTabs value="0">
            <UTabList>
                <UTab value="0" as="div" class="flex items-center gap-2">
                    <UAvatar image="https://primefaces.org/cdn/primevue/images/avatar/amyelsner.png" shape="circle" />
                    <span class="font-bold whitespace-nowrap">Amy Elsner</span>
                </UTab>
                <UTab value="1" as="div" class="flex items-center gap-2">
                ...
                <UTab v-slot="slotProps" value="2" asChild>
